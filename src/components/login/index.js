                            ...
                            <div className=" p-4 bg-white border shadow-lg rounded signup-box">
                                    ...
                                    {({ isSubmitting }) => (
                                        <Form> {/* Include Form component here */}
                                            ...
                                            {/* <div className='form-group text-end'>
                                                <Link href="forgotPassword" style={{ color: "#706C61", textDecoration: "none" }}>Forgot Password?</Link>
                                            </div> */}
                                ...
                                <div className="row pt-3">
                                    <div className="col-lg-12 text-center">
                                        <p class="text-center"> Don't have an account?  <Link href="/register" style={{ color: "#706C61", textDecoration: "none" }}><strong>Register</strong></Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
