...
import styles from './terms-and-conditions-policy.module.scss'
    ...
    <>
      <section className={styles.dlftbnnr}>
        <div className={styles.dlftCtnt}>
          <h1 style={{ fontWeight: '300' }}>TERMS AND CONDITIONS POLICY</h1>
          <p>Home &gt; Terms And Conditions Policy</p>
        </div>
      </section>
      <section className='my-5'>
        <Container>
          <p>These Website Standard Terms and Conditions written on this webpage shall manage your use of our website, accessible at HouseOfEm5.com.
            These Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed to accept all terms and conditions written in here. You must not use this Website if you disagree with any of these Website Standard Terms and Conditions.</p>
          ...
          <p>These Terms will be governed by and interpreted in accordance with the laws of India, and you submit to the non-exclusive jurisdiction of the state and central courts located in Country for the resolution of any disputes.</p>
        </Container>
      </section>
    </>
  )
